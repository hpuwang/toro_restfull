  ...
  static function getTableName()
    {
        ...
        return self::getConfig("app.db.prefix") . $className::$tablename;
    }

    static function getConfig($key){
        return tr::config()->get($key);
    }

    static function tableName($tableName='')
    {
        if(!$tableName){
            return self::getConfig("app.db.prefix") .self::$tablename;
        }
        return self::getConfig("app.db.prefix") . $tableName;
    }
    ...
    static function insert(array $data)
    {
        ...
        if (self::getConfig("app.db.auto_time")) {
